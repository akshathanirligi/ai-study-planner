...
const [matchedCards, setMatchedCards] =
    ...
    const fetchTasks = async () => {
        ...
        try {
            ...
            const res = await axios.get(
                "https://ai-study-planner-1-9uvs.onrender.com/api/study"
            );
    ...
    try {
        ...
        if (editingTask) {
            ...
            await axios.put(
                `https://ai-study-planner-1-9uvs.onrender.com/api/study/${editingTask}`,
                {
                    subject,
                    studyNotes,
                    priority,
    ...
    const deleteTask = async (id) => {
        ...
        try {
            ...
            await axios.delete(
                `https://ai-study-planner-1-9uvs.onrender.com/api/study/${id}`
            );
